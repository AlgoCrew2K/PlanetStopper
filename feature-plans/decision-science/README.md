...
- **S-1 stub vs S-1 plan.** `s1-two-stage-parity-gate/plan.md` is a 15-line table-form stub (teammate-authored). The risk-architect drafted a deeper version held outside the file tree; the cross-review will pull in the deeper structure (six RED tests, K-1 ★ rubric, attribution-table schema) and supersede the stub.
