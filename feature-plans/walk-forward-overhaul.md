...
- **OPEN — SIP-everywhere A/B**: whether upgrading BOTH train + live to SIP ($99/mo recurring) materially improves *realized* VWAP-exit performance for the 4 thin-volume symphonies (`8FAXAnQmYi1INDubazeC`, `n2ooAZTvBRN6ZzpMmWmU`, `qF5ZU7ALjrlhxrGEwsyJ`, `hvPiGP1O7AHfutHE3Fjy`) is being decided by an A/B experiment (Databento free credits): recompute VWAP SIP-vs-IEX over a recent window + measure the guard-alpha/drawdown delta. The 7 clean symphonies gain nothing from SIP. Cost-vs-performance call is the operator's, informed by the A/B number.
