...
**Last regenerated:** 2026-06-15 (lens-technicals — advisors/lens_technicals.py producer + ai_advisor._build_technicals_section wiring; MA posture/breadth/momentum from Alpaca daily bars via synthetic_history cache)
...
| `ai_advisor` | [ai_advisor.md](ai_advisor.md) | Claude-backed config advisor: context assembly, per-symphony assessment, structured-output Claude call, safety gates (7-item allowlist, risk-direction check, OOS re-validation), and multi-lens pipeline (technicals + sentiment wired; derivatives/macro/fundamentals stubs) | 2026-06-15 |
