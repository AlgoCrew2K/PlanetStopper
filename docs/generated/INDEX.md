...
| `advisors/lens_breadth` | [advisors_lens_breadth.md](advisors_lens_breadth.md) | 500-name S&P market-breadth producer: % of constituents above 50/200-day SMA (gold-standard breadth) over a qualifying sub-universe; free (datahub/Wikipedia constituents + Alpaca IEX bars); persists to warehouse; IEX-basis caveat; D-1; honest-availability | 2026-06-14 |
...
| `advisors/lens_crossasset` | [advisors_lens_crossasset.md](advisors_lens_crossasset.md) | Cross-asset risk-appetite lens: risk-on/off read from 6 free Alpaca ETFs (HYG−LQD credit, TLT, UUP, GLD, EMB, DBC); per-component momentum signals + derived aggregate (no hardcoded signs, regime-robust); honest-availability, D-1, persists to warehouse; inflation excluded (separate macro concern); no production caller yet | 2026-06-14 |
| `advisors/lens_technicals` | [advisors_lens_technicals.md](advisors_lens_technicals.md) | B2 Alpaca-bar technicals producer: SMA posture (50/200-day), breadth, momentum via synthetic_history.fetch_bars; bounded retry; D-1 error contract; honest-availability (EmptyUniverse when universe=[]); wired into ai_advisor._build_technicals_section (lazy import, CC-2) | 2026-06-13 |
