...
**Last regenerated:** 2026-06-13 (feat/lens-warehouse — advisors/lens_warehouse.py: separate warehouse SQLite DB, append-only snapshot store with secret-stripping; no production caller yet; DE-WARCH-001 added to DECISIONS.md)
