...
| `database` | [database.md](database.md) | SQLite state management: schema, 31 migrations (001–031), and all read/write accessors including per-symphony live-mode, regime cache, PBO column, and also_true_json | 2026-06-02 |
