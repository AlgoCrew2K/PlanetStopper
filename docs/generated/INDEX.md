...
**Last regenerated:** 2026-06-13 (cycle3-lens-swaps — lens-informed asset-swap ranking added to advisors/asset_swap_engine.py; extract_lens_scores + LENS_BLEND_WEIGHT + _apply_lens_blend; generate_objective_directed_candidates / propose_operator_swap / suggest_swaps gain lens_scores kwarg; persistence gains lens_evidence + sources fields)
