...
**Source:** `reporting.py`
**Last updated:** 2026-07-09 (DE-PROD-ACCURACY-001: Stage-1 if-held sourcing corrected to read the `shadow_history` table directly, with explicit `if_held_source` provenance and an off-schedule snapshot-cutoff invariant; supersedes the 2026-06-22 doc claim below)
