...
def build_restart_notice_context(
    ...
    Clears (restart_required=False) when daemon_started_at > toggle_changed_at.

    Both values are ISO 8601 strings; lexicographic comparison is valid for
    UTC timestamps in the same timezone.
    """
