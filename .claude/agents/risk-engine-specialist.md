...
description: "Math-heavy core specialist for math_engine.py, alpha_bot_execution.py, and synthetic_history.py. Owns numerical correctness, constant provenance, and exit-decision safety for the Planet Stopper risk engine."
