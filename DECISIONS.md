...
Branch: `fix/f008-data-integrity` | Base: `origin/main` (post `DE-AUTOTUNE-REPORTING-001`) `c1eb746b` | RED: `f33684b4` | GREEN round 1: `500964ff` | REVIEW RED (blast-radius + crash-gap): `eb56d9ac` | GREEN round 2: `2eac42d0` | HEAD (this entry): `ded5f853` (team-lead ruling applied post-hoc on wall-clock-date handling)
